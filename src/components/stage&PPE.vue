    ...
    <div class="container-fluid activity">
      ...
      <div class="row justify-content-lg-center">
        <div class="col-md-12 col-lg-8 explainActivity">
          <div
            data-aos="fade-right"
            v-if="$route.params.typeOfActivity == 'stage'"
          >
            ...
            <p>
              <a
                ...
                >Lyon Métropole Habitat</a
              >
              est une grande entreprise située sur plusieurs secteurs. Le siège
              de cette dernière se trouve dans le troisième arrondissement de
              Lyon. L’entreprise a pour but principal de vendre et de faire
              louer des appartements. Ils possèdent plusieurs secteurs tel que
              le secteur informatique ou les ressources humaines.
            </p>
          </div>
          ...
          <div class="realisation">
            ...
            <div v-if="name == 'Le maquetage des pages'">
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    J’ai fait une première page avec le peu de donnée que l’on
                    m’avait dit avec de simple carré et du texte dedans.
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
                    :src="
                      require('@/' +
                        this.imgSchPath +
                        'stage/1ere_annee/premiere_page.png')
                    "
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Une première page peut être trop simple pour les personnes
                    venant des Ressources Humaine j’ai donc dû la refaire et
                    j’ai finis par faire ça
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
                    :src="
                      require('@/' +
                        this.imgSchPath +
                        'stage/1ere_annee/accueil(menuOuvert).png')
                    "
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Une page simple avec la possibilité de faire de sous menu
                    j’ai montré ça aux RH et le code à mon tuteur puis il m’a
                    dit de tout refaire mais en orienté objet. J’ai eu beaucoup
                    de mal au début puis j’y ai pris gout et toute cette
                    première page était en objet
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
                    :src="
                      require('@/' +
                        this.imgSchPath +
                        'stage/1ere_annee/Atom_code_accueil.png')
                    "
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Un ajout, une modification ou une suppression à la fois
                    simple et rapide tout était fait pour que le développeur
                    fasse simplement ce qu’il voulait. Il fallait donc ensuite
                    continuer comme cela et faire la suite de ce site, j’ai
                    commencé par faire l’entrée d’une personne dans
                    l’entreprise, mais avant de commencer j’ai demandé les
                    attentes de mon tuteur, soit, une page qui reste la même
                    cela sera seulement un remplacement de div que l’on fera
                    avec Ajax (Voir dans le 2eme contexte). J’ai alors produis
                    cela
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Enfin ça c’était le screen final, nous ne voyons pas mais
                    grâce à jQuery j’ai pu faire quelque animation qui était
                    aussi là pour faire camoufler le temps de chargement de la
                    prochaine div
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Je n’ai plus le code mais cette page était elle aussi
                    complètement en objet. On pouvait dans le code sélectionner
                    les jours et ou les demi-journée qu’on voulait griser
                    simplement en tapant le nom de la journée.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div v-if="name == 'jQuery.ajax, le chargement des pages'">
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    J’ai beaucoup utilisé la documentation de jQuery et d’Ajax,
                    qui sont très bien faites. La présence de mon tuteur m’a
                    aussi permis de mieux m’initier là-dedans.
                  </p>
                </div>
              </div>
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Après plusieurs modifications, cette page était utilisée
                    comme principale pour le site. Cette dernière complètement
                    orienté objet permet la facilité au futur modification
                    qu’ils voudront apporter.
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Dans ce menu, quand on allait dans un contexte, par exemple
                    une entrée, on se retrouvait sur cette page qui étais généré
                    complètement en JavaScript et faisais charger les données
                    des menus déroulant grâce à Ajax, car nous avions besoin de
                    charger les données sans recharger la page.
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    Je pouvais ensuite me rediriger vers les autres pages lors
                    d’un clic sur le bouton suivant ou précédent, sans changer
                    de page c'était juste un remplacement de div, et donc
                    lorsque je cliquais cela faisais charger grâce à Ajax les
                    données de la page concerné.
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
                    :src="
                      require('@/' +
                        this.imgSchPath +
                        'stage/1ere_annee/equipement.png')
                    "
                    alt="equipement.png"
                    class="img-fluid"
                  />
              ...
              <div data-aos="fade-right" class="row">
                <div class="col-lg-12 col-md-12">
                  <p>
                    On peut voir sur un bout de code ci-dessous où lors d’un
                    clic, Ajax allais faire charger la page souhaité.
                  </p>
                </div>
                <div class="col-lg-12 col-md-12">
                  <img
                    :src="
                      require('@/' +
                        this.imgSchPath +
                        'stage/1ere_annee/ajax_code.png')
                    "
                    alt="ajax_code.png"
                    class="img-fluid"
                  />
            ...
            <div v-if="name == 'C++: Les arbres et les Template'">
              ...
              <Realisation p="L’arbre AVL a été assez dur à implémenter à cause des concepts avancer du C++, comme les pointeurs, les références, des Template grâce au type T et d’autre détails du au compilateur ou directement au langage. La fonction la plus compliquer a été l’insertion, ainsi que les rotations, du a l’arbre qui se veut comme ça. Le code de l’insertion est surtout basé sur un équilibrage et donc des rotations." imgPath="ecole/INF3105/class_arbreAVL-insertion.png"></Realisation>
            </div>
          </div>
